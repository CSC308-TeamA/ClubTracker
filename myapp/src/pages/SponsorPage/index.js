...
function Sponsor() {
  ...
  const thankYouParagraph = 'Our team would not be able to compete if it weren\'t for our great sponsors. If you would like to help contribute to our team, please consider being a sponsor. Our goal this year is to raise between $15,000 - $20,000. We are a 501(C)3 non profit organization so if you need a tax deductible receipt, that can be arranged. Please click on the contact button above to contact us for more information.';
