...
import { NavLink, NewDiv, NewCard, Center, NewModal } from './SignUpPageElements'
                ...
                <Form>
                    ...
                    <NewModal show={show} onHide={handleClose}>
                        <NewModal.Header closeButton>
                            <NewModal.Title>Hello 👋! Thank you for signing up. Please confirm your information below.</NewModal.Title>
                        </NewModal.Header>
                        <NewModal.Body>
                            <ProfilePreview characterData={characters} />
                            <p>You can proceed to the discussion board or stay here...only if you want to...</p>
                            </NewModal.Body>
                        <NewModal.Footer>
